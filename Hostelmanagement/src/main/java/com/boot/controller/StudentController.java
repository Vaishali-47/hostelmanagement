...
import com.boot.service.StudentService;
	...
	public class StudentController {
		...
		public ResponseEntity<StudentDTO> addStudent(@Validated @RequestBody StudentDTO student)
		{
			//ResponseEntity
		...
		public ResponseEntity<StudentDTO> updateStudentById(@Validated @RequestBody StudentDTO student,@PathVariable("studentId") int studentId)
		{
...
//		@GetMapping("/check")
//		public ResponseEntity<StudentEntity> checkLogin(@RequestParam("email") String email)
//		{
//			
//			  StudentEntity checkLogin=this.studentService.checkLogin(email);
//			if(checkLogin!=null)
//			{
